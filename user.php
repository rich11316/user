...
$ads= $putih."[÷]    SI KAMPRET    [÷]".$t.$ijo."[-] ORANG GOBLOK ".$putih."| atau |".$ijo." ORANG TOLOL [-]";
$msgtoto = "[!] BODOH";
$msgyd = "[!] update [v.1.2]";
...
//YD
'R Panji Tri Wahyudi','Charles','Richard The Lionheart','richard.thesteam11316@gmail.com','richard.arima11316@gmail.com'
//mpiv
        ];
$toto = ['tes',];
$ydnews = ['tes','premium',];
